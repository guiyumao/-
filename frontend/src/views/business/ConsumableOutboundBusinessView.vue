    ...
    <div>
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">按实验室与耗材联动可用批次，自动带出单价并校验可用库存，同时保留教师和学生申请来源。</p>
            </div>
            <el-space>
        ...
        <el-row :gutter="20" class="stats-row">
            <el-col :xs="24" :md="8">
                <el-card class="card-panel metric-card" shadow="never">
                    ...
                    <div class="metric-note">当前记录已串联申请人、审批人和操作人</div>
                </el-card>
            </el-col>
            <el-col :xs="24" :md="8">
                <el-card class="card-panel metric-card" shadow="never">
        ...
        <div class="sample-showcase">
            <div class="sample-section-head">
                <div>
                    ...
                    <p class="section-desc">这里直接展示真实的教师和学生申领记录，和批次、审批、操作人一起看，避免单独一块逻辑。</p>
                </div>
